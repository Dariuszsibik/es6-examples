...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_iteracja__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_generatory__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_generatory___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__js_generatory__);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_map__ = __webpack_require__(60);
...
var m = new __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_map___default.a();
m.set(1, "React");
m.set(2, "Angula");
m.set(3, "Ember");
m.set(4, "Babel");
...
//     console.log(v)
// }
console.log("obiekt Map mo\u017Cemy iterowa\u0107 poprzez for of, size() pobiera ilo\u015B\u0107 element\xF3w " + m.size);
...
var set = new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_set___default.a();
set.add(10);
set.add(20);
set.add('ok');
set.add(true);
...
window.onload = function () {
    ...
    try {
        for (var _iterator = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator___default()(paragraphs), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var p = _step.value;
...
console.log("querySelectorAll wraca NodeList kt\xF3ra mo\u017Cna iterowa\u0107 for of i na ka\u017Cdym elemencie dokona\u0107 zmiany");
...
var users = createIterator(["Andrzej", "Piotr", "Marek", "Tomek"]);
console.log("Iterator mo\u017Cna stworzy\u0107 funkcj\u0105, next(to metoda kt\xF3ra zwraca value(Warto\u015B\u0107) i done(false - je\u015Bli ostatni element)) " + users.next().value);
